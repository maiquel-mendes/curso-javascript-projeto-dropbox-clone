class DropBoxController {
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyCEnKEwTMwtJax2gbrQoOOFNof2y3F2SE4",
            authDomain: "dropbox-clone-cfc3a.firebaseapp.com",
            databaseURL: "https://dropbox-clone-cfc3a-default-rtdb.firebaseio.com",
            projectId: "dropbox-clone-cfc3a",
            storageBucket: "dropbox-clone-cfc3a.appspot.com",
            messagingSenderId: "1048275920273",
            appId: "1:1048275920273:web:9eb9d08c632ae63a53e630",
            measurementId: "G-4E14LTRBCS"
        };
        // Initialize Firebase
    ...
    initEvents() {
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.uploadTask(event.target.files).then(responses => {
                ...
                console.log('respnses', responses)
